...
//                            use Google\Analytics\Data\V1beta\Metric;
                            ...
                            foreach ($response->getRows() as $row) {
                                if($count < 3) {
                                    echo '["'.$row->getDimensionValues()[0]->getValue().'", '.$row->getMetricValues()[0]->getValue().'],';
                                    $count++;
                                }
                            }
